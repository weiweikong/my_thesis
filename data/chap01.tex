...
\begin{figure}[htb]
	...
	\subfloat[X-47B公布的视频中，位于舰桥的疑似毫米波雷达引导系统]{%
...
\begin{figure}[htb]
	\centering%
	\subfloat[飞机在右偏，高度高于标准下滑曲线时的仪表显示]{%
		\label{fig:07_ILS1}
		\includegraphics[height=7cm]{Figs/07_ILS1.pdf}}\hspace{4em}%
	\subfloat[飞机在左偏，高度低于标准下滑曲线时的仪表显示]{%
		\label{fig:08_ILS2}
...
无人机通用自动回收系统(UCARS, UAS Common Automatic Recovery System）-V2系统（如图\ref{fig:29_UCARS}）由内华达山脉公司（SNC）设计，为MQ-8B和MQ-8C火力侦察兵旋翼无人机提供自动着陆能力，并能够在很多其他平台上运行。该系统是SNC的AN/UPN-51(V)无人机通用自动回收系统（UCARS）的改进型，和先锋无人机一起被美国海军陆战队使用。

该系统是以跟踪雷达为基础的自动起降系统的典型代表。毫米波雷达比微波雷达体积小、重量轻、波束窄、带宽大、抗干扰能力强；比红外或激光传感器气象适应性好，可穿透雨、雾、战场浓烟、尘埃进行探测，所以它是继激光、红外之后电磁频谱利用中的又一枝新秀。UCARS-V2有两个主要组件。一个是机载的应答器系统，另一个是舰载或陆基跟踪子系统，即定位和跟踪机载应答器子系统。跟踪传感器可测量飞机的运动和与期望降落点的相对位置，并能够输出稳定的位置和移动数据，供自动精密定位所用；它还有一个平行对准照相机，可以为无人机的操作员提供实时信息。

UCARS-V2具备全天候、昼夜、自动起降能力可用于固定翼和旋翼无人机，能够在舰船和陆地基站上操作。系统具备自动着陆能力,与无人机平台类型无关。此外，V2改进版的系统不需要飞行员和GPS或从船上获得更多的位置信息。它还具备船舶运动稳定设备，使其在不良海况仍能正常运行，如图\ref{fig:30_UCARS2}所示。该系统的引导控制精度在2.5厘米左右。
...
法国DCNS公司开发的SADA自动甲板起降系统\cite{DCNS}使用红外传感器精确跟踪无人机，同时发出飞行指令调整航线直到确保无人机的“鱼叉”式着陆装置对准降落格栅的中心。2008年10月9日和10日，SADA成功地使一架奥地利西贝尔公司研制的“坎姆考普特”（Camcopter）S-100旋翼无人机以自动模式在一艘正在地中海航行的法国海军驱逐舰“蒙特卡姆”号（Montcalm）上完成降落。该系统技术手册上称，引导控制精度约30厘米，可以在五级海况条件下正常工作。
...
2013年6月，奥地利西贝尔电子设备公司的“坎姆考普特”S-100 无人直升机配装欧洲航宇防务集团（EADS）阿斯特里姆公司的“甲板发现者”（DeckFinder）区域定位系统，在一周的时间内完成了一系列旨在演示验证GPS干扰环境中无人机自动起飞与回收能力的飞行试验。“甲板发现者”系统\cite{Deckfinder}包括地面部分和机载部分，其中地面部分包括6台射频发射机，机载部分包括1台接收机。该系统的测距不依赖于GPS，可为航空器提供高精度的三维相对位置信息。根据公布的技术细节，该系统的工作范围约为1.1公里，降落阶段精度由于20厘米，工作频率高于15赫兹。
\begin{figure}[!tb]   
	\centering	
...
通过阅读相关资料并分析，该联合精确进场与着舰系统（JPALS）由处理、维修和监测系统，UHF数据链，惯性传感器和GPS传感器等组成，可以实现高可靠性和可用性。JPALS将与AN/TPX-42空中交通管制雷达、AN/SPN-46自动着舰系统、AN/SPN-41着舰辅助雷达、着舰信号官显示系统、改进型菲涅耳透镜光学着舰系统、航空数据管理和控制系统系统集成。2011年7月，F/A-18D“大黄蜂”战机在“艾森豪威尔”航空母舰上实现无人控制自主降落。
...
\begin{figure}[htb]   
	\centering
	\includegraphics[height=7cm]{figs/chp01/chp01_03_CMU_Sea_Landing.pdf}
	\caption{卡内基梅陇大学直升机机载视觉传感器在降落过程中的对降落目标位置和姿态的解算\cite{Grocholsky2016}}
	\label{fig:chp01_03_CMU_Sea_Landing}
\end{figure}

此外，通过机载传感器直接识别机场跑道，也可以视为一种基于合作标识的降落方法。德国宇航中心DLR飞行控制研究所提出了一种利用可见光、红外或雷达图像中的跑道信息估计固定翼飞机的相对位置的方法，并在其研制的ESVS（Enhanced and Synthetic Vision）平台上得到验证[105]。

\subsection{地基传感器引导降落系统} 

用于户外的地基引导系统并不常见，文献[100]给出固定位置的地基引导系统，通过识别无人机上悬挂的红外标记，完成对无人机的引导降落。无人机按照7度下滑线下滑，在400米处高度为49.114米，像机视场为167.94×138.5 米。在像机像面垂直于跑道的情况下，在离像机50米处，高度分辨力为0.032，水平分辨力为0.26米，改变像机光轴方向即可改变水平方向分辨力，如图2.11所示。

国防科技大学航天学院提出了采用多台固定焦距摄像机分区域接力测量的方案如图2.13所示。视觉引导系统由六台摄像机和配套计算机组成，三组摄像机选取不同的焦距，分别观测远场、中场和近场区域，保证相邻两组摄像机视场有一定的重叠区域，并覆盖整个着陆区[9]。

文献[73]给出了一种基于步进电机和网络摄像头结合的引导设备，可以对微小型无人机进行跟踪，但其视场角收到步进电机的约束。Martinez[74]提出了一种三目摄像机系统，如图2.14所示，该系统可以检测无人机的特征点，得到位置信息，但由于构型限制，该系统只适用于旋翼直升机的降落。Stanford大学[32]使用两个或以上的相机得到了距离40米外，位置误差约25厘米的视觉系统，但文献中没有具体描述系统的具体结构。利用BumbBee系统，Chiba大学[80]成功将一架四悬翼从6米的高度引导角落。
