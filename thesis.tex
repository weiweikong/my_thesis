...
%\documentclass[doctor,twoside,otf,anon]{nudtpaper}
...
\confidentiality{公开}
\UDC{}
\title{基于多传感器的无人机自主着舰\\引导与控制系统研究}
\displaytitle{基于多传感器的无人机自主着舰引导与控制系统研究}
\author{孔维玮}
\zhdate{二〇一七年七月}
\entitle{Multi-sensor based Autonomous Landing Guidance and Control System of a Fixed-wing Unmanned Aerial Vehicle}
